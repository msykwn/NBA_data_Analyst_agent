...
利用可能なツール:
- get_player_stats: 選手のシーズン個人スタッツを取得
- get_player_recent_games: 選手の直近N試合のスタッツを取得
- get_player_info: 選手の所属チーム・ポジション情報を取得
- get_team_standings: リーグ全チームの順位・成績を取得
- get_team_game_log: チームの直近の試合結果を取得
- get_position_avg_stats: ポジション別の平均スタッツを取得

注意事項:
- 選手名・チーム名が見つからない場合は、候補リストをそのままユーザーに返してください
- シーズンの指定がない場合は、デフォルトの2024-25シーズンを使用してください
"""
